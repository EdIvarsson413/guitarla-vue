    ...
    <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        ...
        <div class="col-8">
            ...
            <button 
                ...
                @click="$emit('agregar-carrito', guitarra) /* forma de usar funciones heredadas a componentes */"
            >
                Agregar al Carrito
            </button>
        </div>
...
// Eventos de componente, en el componente hijo se declara que metodo es
